...
describe('ScoreCalculator', function () {
    ...
    test('calculates underestimate score for an index', function () {
        var guess = 5;
    ...
    test('calculates overestimate score for an index', function () {
        var guess = 8;
