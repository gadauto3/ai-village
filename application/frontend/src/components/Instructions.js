...
import { InstructionsInit, InstructionsInteract, InstructionsNoticeAI2, InstructionsShowCredits } from "./longStrings";
...
const Instructions = (gameState) => {
  ...
  return (
      <div className="instructions">
          <p><strong>Instructions: </strong>{getInstructionsForState(gameState)}</p>
      </div>
  );
}
